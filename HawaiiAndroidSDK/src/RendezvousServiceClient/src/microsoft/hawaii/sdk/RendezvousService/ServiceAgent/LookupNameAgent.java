...
/**
 * Service Agent class to look up name from DateBase
 */
public class LookupNameAgent extends ServiceAgent<NameRegistrationResult> {

	/**
	 * 
	 * Initializes an instance of the {@link LookupNameAgent} class
	 * 
	 * @param baseUri
	 ...
	 * @throws Exception
	 */
	public LookupNameAgent(URI baseUri, ClientIdentity clientIdentity,
