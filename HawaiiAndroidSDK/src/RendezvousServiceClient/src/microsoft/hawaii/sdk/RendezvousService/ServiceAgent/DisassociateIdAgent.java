...
/**
 * Service Agent class to dissociate a registration id to a name with the
 * service.
 */
public class DisassociateIdAgent extends ServiceAgent<NameRegistrationResult> {

	/**
	 * 
	 * Initializes an instance of the {@link DisassociateIdAgent} class
	 * 
	 * @param baseUri
	 ...
	 * @throws Exception
	 */
	public DisassociateIdAgent(URI baseUri, ClientIdentity clientIdentity,
